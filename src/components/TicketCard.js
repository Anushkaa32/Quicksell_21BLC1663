...
const TicketCard = ({ ticket }) => {
  // Define a function to get the priority icon based on the ticket's priority
      ...
      case 4:
        return (
          <svg
            ...
            style={{ marginRight: '8px' }} // Added marginRight for spacing
          >
  ...
  return (
    <div className="ticket-card">
      ...
      <div className="ticket-tag">
        {/* Grey urgent icon before the Feature Request */}
